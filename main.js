function refreshTable(){
    ...
    for(var i=0; i<amount; i++){
        ...
        var clr = gameCrash > cashout ? 'green': (gameCrash < cashout ? 'red' : 'blue');
        ...
        tableBody.innerHTML += "<tr><td>"+gameHash+"</td><td style='background:" + clr + "'>"+gameCrash+"</td><td>"+betAmount+"</td><td style='background:" + clr2 + "'>"+coins+"</td><td>";
